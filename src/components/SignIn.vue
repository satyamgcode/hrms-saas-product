<template>
  <div class="min-h-screen flex items-center justify-center font-['Outfit',sans-serif] relative overflow-hidden bg-gray-900">
    ...
    <div class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#8A3EEA]/20 rounded-full blur-[120px] animate-pulse"></div>
    <div class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#F3901B]/20 rounded-full blur-[120px] animate-pulse" style="animation-delay: 2s"></div>
    
    
    <div class="flex w-full max-w-5xl bg-white rounded-3xl shadow-[0_20px_50px_rgba(138,62,234,0.15)] overflow-hidden min-h-[600px] relative z-10 border border-white/50 backdrop-blur-sm">
      <!-- Left Side: Company Information -->
      <div class="hidden md:flex md:w-1/2 bg-gradient-to-br from-[#8A3EEA] via-[#a365f5] to-[#F3901B] p-16 text-white flex-col justify-between relative overflow-hidden">
        ...
        <div class="max-w-md mx-auto w-full">
          ...
          <form @submit.prevent="handleSignIn" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
              ...
              <a href="#" class="text-sm font-medium text-[#8A3EEA] hover:text-[#F3901B] transition-colors">Forgot password?</a>
            </div>
